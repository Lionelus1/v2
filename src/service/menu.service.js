  ...
  getGlobalMenu($t) {
    ...
    return [
      ...
      },
      {
        ...
        visible:
          this.isVacancyRightsValidity() ||
          (this.isEnuWorker() &&
            (this.findRole("dephead") ||
              this.findRole("practice_responsible") ||
              this.findRole("main_administrator") ||
              this.findRole("hr_manager"))),
        items: [
          {
          ...
          },
          {
            ...
            to: "/cafedra",
            visible:
              this.findRole("dephead") || this.findRole("practice_responsible"),
          },
          {
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            visible:
              this.findRole("dissertation_chief") ||
              this.isRoleGroupMember("dissertation_council") ||
              this.findRole("main_administrator"),
            items: [
              {
                ...
                visible:
                  this.findRole("dissertation_chief") ||
                  this.findRole("dissertation_council_secretary") ||
                  this.findRole("main_administrator"),
              },
              {
      ...
      },
      {
        ...
        visible:
          this.findRole("enu_web_admin") ||
          this.findRole("enu_web_fac_admin") ||
          this.findRole("enu_web_page_admin"),
        items: [
          {
            ...
            visible:
              this.findRole("enu_web_admin") ||
              this.findRole("enu_web_fac_admin") ||
              this.findRole("enu_web_menu_admin"),
          },
          {
        ...
        items: [
          {
            ...
            visible:
              this.findRole("main_administrator") ||
              this.findRole("online_course_administrator"),
          },
          {

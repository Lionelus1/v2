				...
				changeLanguage() {
					...
					switch(this.$i18n.locale) {
						case "kz":
							...
							this.$primevue.config.locale.dateIs = 'Осы күні',
							this.$primevue.config.locale.dateIsNot = 'Осы күні емес',
							this.$primevue.config.locale.dateBefore = 'Осы күннен бұрын',
							this.$primevue.config.locale.dateAfter = 'Осы күннен кейін',
						...
						case "ru":
							...
							this.$primevue.config.locale.dateIsNot = 'Не это дата',

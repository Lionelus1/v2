<template>
    <div class="layout-topbar no-print">
        ...
        <Sidebar v-model:visible="visibleRight"
            ...
            <h3>Notifications</h3>
            <div>
                <div  v-for="n,ni in notifications" :key="ni" style="overflow: hidden; clear: left; width: 100%; display: block; margin-bottom:25px;padding-bottom:15px;border-bottom:1px dotted #ccc;">

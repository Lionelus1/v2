export default {
    common: {
        checkTaskCompletion: "Келісуге жібермес бұрын, барлық тапсырмалар нәтижелерімен толтырылуы тиіс",
        ...
        selectContr: "Келісімшартты көрсету",
        edit: "Өзгерту",
        correction: "Түзету",
        ...
        successfullyFormed: 'Есеп сәтті түрде құрылды',
        deletedSuccessfully: "Сәтті жойылды",
        successfullyReset: "Параметрлер сәтті түрде қалпына келтірілді",
        group: 'Топ',
        ...
        downloadAllDocument: "Барлығын бір архивте жүктеу",
        ...
        fundInfo: "Қаржыландыру көзі",
        resultInfo: "Жоба нәтижелері",
        zhtn: "ЖТН",
        sciProject: "Ғылыми жоба",
        projectName: "Жобаның атауы",
        projectNameKZ: "Жобаның қазақша атауы",
        projectNameRU: "Жобаның орысша атауы",
        projectNameEN: "Жобаның ағылшынша атауы",
        projectSupervisor: "Жобаның ғылыми жетекшісі",
        projectYears: "Іске асыру кезеңі",
        projectContract: "Келісім-шарт",
        projectPlan: "Күнтізбелік жоспар",
        projectPriority: "Басымдық бойынша",
        projectRelevance: "Өзектілігі",
        projectGoal: "Мақсаты",
        projectTypeOfResearch: "Зерттеу түрі",
        nameOfPriorityArea: "Басым бағытының атауы",
        projectObjectives: "Жоба міндеттері",
        projectAppAreas: "Қолдану аясы",
        projectAchievedResults: "Қол жеткізген нәтижелер",
        projectYear: "Жыл",
        projectRes: "Нәтиже",
        projectPulish: "Жарияланымдар",
        projectPublishAdd: "Жарияланым қосу",
        projectContractNum: "Келісім-шарт нөмірі",
        projectContractDate: "Келісім-шарт уақыты",
        projectClient: "Тапсырыс беруші",
        projectFundingType: "Қаржыландыру түрі",
    ...
    contracts: {
        ...
        menu: {
            ...
            registerProtocols: "Хаттама реестрі",
            registerProtocolExtracts: "Қатысты құжаттар",
            protocolsJournalDesc: "Қол қоюға және орындауға хаттамалардың тізімі",
        },
    ...
    dissertation: {
        ...
        generateDiaryReport: 'Күнделік есебі',
    ...
    workPlan: {
        ...
        week: "апта",
        monthAndDate: "Ай мен күн",
        textCS: "Қауіпсіздік тақырыбының мазмұны",
        ...
        protocol: {
            ...
            invitedPersons: "Шақырылғандар",
            autogenerate: "Құрылған кезде автоматты түрде жасалады",
            agendas: "Күн тәртібі",
            votingResults: "Дауыс беру нәтижесі",
            speaker: "Баяндамашы",
            decided: "Шешім қабылдады",
            aye: "Қолдағандар",
            con: "Қарсы болғандар",
            abstained: "Қалыс қалғандар",
            decisionAccepted: "Шешімді қабылдағандар",
            closingTimeMeeting: "Отырыстың жабылған уақыты",
            addDecision: "Шешім қосу",
            reported: "Хабарлаған",
            boardDecision: "Басқарма шешімі",
            responsivePerson:"Жауапты тұлға",
            deadline: "Аяқталу мерзімі",
            alreadyCreated: "Бұл хаттама құрылған",
            alreadyInsertedUser: "Бұл мүше қосылған",
            viewDecision: "Шешімдерді қарау",
            innerRule: "Ішкі ережелер",
            briefDesc: "Қысқаша сипаттамасы",
            generateDocStatement: "Деректің көшірмесін жасау",
            ...
            messages: {
                ...
                decisionRemovedSuccess: "Шешім сәтті өшірілді",
                decisionNotFound: "Шешім табылмады",
    ...
    responseExplanations: {
        ...
        userDetailInvalid: 'Сіз енгізген қолданушы осы білім беру бағдарламасына тиісті емес. Қолданушының мәліметтерін қайта тексеріңіз',
        existingPracticeAgreementsMessage: "Бұл студенттің тағылымдамадан өтуге белсенді келісім-шарттары бар",
    },
    visuallyImpaired: {

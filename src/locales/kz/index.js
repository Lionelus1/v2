export default {
  common: {
    ...
    message: {
      title: {
        ...
        yearlessthancurrentyear:
          'Таңдаған жылыңыздың мәні ағымдағы жылдан кіші немесе тең болу керек',
      ...
      sendToApprovalError:
        'Келісімге жіберуде қате пайда болды. Мәліметтердің дұрыстығын тексеріңіз!',
      ...
      userSuccessInserted:
        'Қолданушы сәтті қосылды, авторизациялық мәліметтерді қолданушға жіберу үшін жүктеп алыңыз. ',
      ...
      accessDeniedAdmin:
        'Сіздің бұл бетті көруге құзыретіңіз жоқ. Рұқсат үшін әкімшілерге хабарласыңыз',
  ...
  contragent: {
    ...
    title: 'Контрагенттер',
    missingDetails:
      'Таңдалған контрагент реквизиттері толық көрсетілмеген (БСН т.с.с.). Жетіспейтін реквизиттерді көрсетуіңзді сұраймыз.',
    menu: {
      select: 'Таңдау',
    },
    columns: {
  ...
  doctemplate: {
    ...
    editor: {
      ...
      orgBIN: 'БСН/ЖСН',
      orgAddress: 'Адрес',
      orgPhone: 'Телефон нөмірі',
      orgBankAccount: 'Банк шоты',
      signerFullname: 'Қол қоюшының толық аты-жөні',
      signerFullnameShorten: 'Қол қоюшының толық аты-жөні (қысқартылған)',
      signerPosition: 'Қол қоюшының позициясы',
      signerCard: 'Қол қоюшының жеке мәліметтері',
      workTypes: 'Жұмыс түрлері',
      person: 'Персона',
      sciadvisor: 'Жобаның ғылыми жетекшісі',
      fullnameShorten: 'Толық аты-жөні (қысқартылған)',
      workTypesItems: '1.3 пункт',
      workTypesTable: 'Кесте',
      agreementDate: 'Келісім-шарт күні',
      mnvoAgreementDate: 'БҒЖМ келісім күні',
      agreementEndDate: 'Қызметтің аяқталу күні',
      projectPosition: 'Жобадағы позиция',
      irn: 'ИРН',
      theme: 'Тақырып',
      mnvoAgreement: 'БҒЖМ келісімнің нөмірі',
      agreementSum: 'Келісімшарт сомасы',
      agreementSumText: 'Келісімшарт сомасы сөзбен',
      executorWorkPlace: 'Орындаушының негізгі жұмыс орны',
      priority: 'Басымдық',
      subpriority: 'Қосымша басымдық',
    },
  ...
  contracts: {
    ...
    columns: {
      ...
      results: 'Нәтижелер',
      task_code: 'Күнтізбелік жоспар бойынша тапсырма коды, кезең',
      work_name: 'Шарт бойынша жұмыстардың атаулары және оны жүзеге асырудың негізгі кезеңдері',
      start_date: 'Басталу күні',
      end_date: 'Аяқтау күні',
      result: 'Күтілетін нәтиже',
      percentage: 'Келісімшарт сомасының пайызы',
      contractNumber: 'Келісімшарт нөмірі',
      contractDate: 'Келісімшарт күні',
      executorName: 'Штаттан тыс қызметкердің Т. А. Ә.',
      executorWorkPlace: 'Негізгі жұмыс орнының лауазымы және ұйымы',
      executorPosition: 'Жобадағы лауазым',
      irn: 'ИРН',
      theme: 'Жоба тақырыбы',
      sciadviorName: 'Жоба басшысының ТАӘ',
      mnvoNumber: 'БҒЖМ келісімнің нөмірі',
      mnvoDate: 'БҒЖМ келісімнің күні',
      contractSum: 'Шарт сомасы, мың теңге',
      serviceDate: 'Қызмет көрсету мерзімі',
      actSumPercentage: 'Акт сомасы %',
      actSum: 'Акт сомасы, мың теңге',
      actNumber: 'Актіні тіркеу нөмірі',
      actDate: 'Актіні тіркеу күні',
      actName: 'Жұмыс атауы / қызмет көрсету',
    },
    filter: {
      button: 'Фильтр',
      author: 'Автор',
      ...
      priority: 'Басымдық',
      subpriority: 'Қосымша басымдық',
      mnvo: 'БҒЖМ келісімнің нөмірі',
      sciadvisor: 'Жобаның ғылыми жетекшісі',
      financing_type: 'Қаржыландыру түрі',
      regNumber: 'Тіркеу нөмірі',
      regDate: 'Тіркелген күні',
      executorWorkPlace: 'Орындаушының негізгі жұмыс орны',
    ...
    contragentWarning:
      'Бұл келісім-шартқа контрагент келісімі сұратылмаған немесе сіздің бұл құжатты көруге рұқсатыңыз жоқ!',
    ...
    labels: {
      ...
      work_types: 'Жұмыс түрлері',
      mnvo: 'БҒЖМ келісім күні',
      agreement_end_date: 'Қызметтің аяқталу күні',
      project_position: 'Жобадағы орны',
      irn: 'ИРН',
      theme: 'Тақырып',
      mnvo_agreement: 'БҒЖМ келісімнің нөмірі',
      agreement_sum: 'Келісімшарт сомасы',
      agreement_sum_text: 'Келісімшарт сомасы сөзбен',
      executor_work_place: 'Орындаушының негізгі жұмыс орны',
      priority: 'Басымдық',
      subpriority: 'Қосымша басымдық',
      financing_type: 'Қаржыландыру түрі',
    },
    ...
    executed: 'Орындалды',
    work_type_note: 'Ескерту: Жоба менеджерлері үшін жұмыс түрлерінің максималды саны 10',
    warnStartBigEnd: 'Мерзімі дұрыс емес',
    persentageNot100: 'Дұрыс емес пайыздар',
    expired: 'Мерзімі өтіп кеткен',
    statusGPC: 'АҚК актілерінің күйі',
    statusGPCFull: 'АҚК актілері: АҚК келісімінің жағдайы мен орындалуы туралы ақпарат',
    financingTypes: {
      government: 'Мемлекеттік тапсырма',
  ...
  ncasigner: {
    qrSinging:
      'Құжатқа "eGov mobile" мобильдік қосымшасының көмегімен төмендегі QR кодты сканерлеу арқылы да қол қоя аласыз:',
    noteMark:
      'Smart.Enu қызметін пайдалана отырып сіз ҰКО сертификатында (электронды қолтаңба) қамтылған жеке мәліметтеріңізді жинауға, өңдеуге және сақтауға келісіміңізді бересіз.',
    chooseFile: 'Файлды таңдаңыз',
    docIdNotExistMessageForFind:
      'Қол қойылған құжаттың бетін файл арқылы табу үшін файл атауында дұрыс SIGNERAPP идентификаторы болуы керек. Файл атауында дұрыс SIGNERAPP идентификаторы бар екеніне көз жеткізіңіз.',
    docIdNotExistMessageForSign:
      'Бұрын қол қойылған құжатқа файл арқылы қол қою үшін файл атауында дұрыс SIGNERAPP идентификаторы болуы керек. Файл атауында дұрыс SIGNERAPP идентификаторы бар екеніне көз жеткізіңіз. Әйтпесе, жаңа қолтаңба тізбегін құру үшін SIGNERAPP идентификаторынсыз файл атауын көрсетіңіз.',
    ...
    linkForOthersTitle:
      'Қол қойылған құжат бетіне сілтемені басқаларға қолтаңбаларды тексеруге және осы құжатқа қол қоюға рұқсат беру үшін пайдаланыңыз:',
    copy: 'Көшіру',
    filHasNoIdTitle: 'Сіз таңдаған файл атауында SIGNERAPP идентификаторы жоқ',
    fileHasNoIdContent:
      'Қол қойылған құжаттың бетін файл арқылы табу үшін файл атауында SIGNERAPP идентификаторы болуы керек. Келесі форматтағы файлды табуға тырысыңыз:',
    ...
    successSignContentSecondRow:
      'Қол қойылған файлдың көшірмесін <b>SIGNAPP идентификаторымен</b> сақтауды ұсынамыз. Болашақта бұл SIGNAPP қызметінде қол қойылған құжаттың бетін іздеуді жеңілдетеді.',
    ...
    tspDescription:
      'Уақыт белгісін тексеру ұзақ мерзім сақталатын электрондық құжаттар үшiн жүргізіледі. Уақыт белгісі ЭЦҚ тексерудің жағымды нәтижесі анықталған кезде электрондық құжатқа қол қойылған сәтте қалыптастырылып, уақыттың көрсетілген кезеңінде құжатқа қол қоюдың дәлелі болып табылады.',
    ...
    error: {
      ...
      certificate: {
        ...
        expiredOrNotYetValid:
          'Сертификаттың жарамдылық мерзімі аяқталды немесе Сертификаттың жарамдылық мерзімі әлі басталмады.',
        notForSigning: 'Сертификат қол қоюға арналмаған',
        notForAuth: 'Сертификат авторизацияға арналмаған',
        signRightsNotFound:
          'Сертификаттың құжаттарға қол қоюға құқығы жоқ (қажетті алгоритм: МЕМСТ)',
  ...
  queue: {
    ...
    call: 'Шақыру',
    warning:
      'Талонды фотоға түсіріп алыңыз немесе «Принтерге шығаруды» басып қағазға шығарыңыз.Фотоға түсірсеңіз міндетті түрде «Жабу» батырмасы арқылы терезені жабыңыз!!!',
    errorPhone: 'Бұл телефон нөмірінде брондау жасалған!',
    reservation: 'Брондау',
    reserve: 'Брондау',
    queueType: 'Кезек түрі',
    mode: 'Жұмыс тәртібі',
    emailReq: 'Электрондық пошта қажет',
    emailInvalid: 'Жарамсыз электрондық пошта',
    emailMsg: 'Ақпаратты скриншот жасап немесе почтаға жіберілген ақпаратты операторға көрсетіңіз!',
    workingDays: 'Жұмыс күндері',
    workingHours: 'Жұмыс тәртібі',
    lunch: 'Түскі үзіліс',
  ...
  dissertation: {
    ...
    message: {
      ...
      saveKey:
        'Дауыс беру анонимді: біз сіздің таңдауыңызды сақтамаймыз. Келешекте өзіңіздің даусыңызды тексере алуыңыз үшін берілген кілттік сөзді жүктеп немесе сақтап алуыңызды сұраймыз. Кілттік сөз тек сізге ғана белгілі және есіңізде сақтап алмаған жағдайда қалпына келтіру мүмкін емес.',
      ...
      reviewerHasAlreadyAdded: 'Рецензент таңдалған докторантқа қосылып қойған',
    },
    states: {
      s0: 'құрылды',
    ...
    setMeetingTimeConfirmMsg:
      'Төмендегі {btn} батырмасын басу арқылы, ақпараттардың дұрыстығын растайсыз және осы ақпарат сайтқа хабарландыру болып шығарылады',
  ...
  hr: {
    ...
    sp: {
      ...
      label1:
        '– ПОҚ, ӘБҚ және ҒҚ бос лауазымдарына орналасуға кандидаттардың түйіндемелерін қарастыру',
      label2:
        '– басқарманың HR маманымен және іріктеуге өтінім жіберген құрылымдық \n' +
        '                бөлімшенің басшысымен сұхбаттасу;',
      label3: '– конкурстық комиссиямен сұхбаттасу және конкурс қорытындысын шығару.',
      agreement:
        'Мен ережелерді оқып шықтым және жеке түйіндемемдегі мәліметтердің дұрыстығын растаймын. \n ' +
    ...
    petition: {
      ...
      error:
        'Өтінішхатқа қол қойылған жоқ. Құжатты құрғаныңызға және оған қол қойғаныңызға көз жеткізіңіз.',
    },
    report: {
      title: 'Есеп алу',
  ...
  workPlan: {
    ...
    minWordCount: 'Мәтіннің ұзындығы 50-ден 250 сөзден аспауы керек',
    maxWordCount: 'Мәтіннің ұзындығы 50-ден 250 сөзден аспауы керек',
    ...
    warnAddingSummaryUser:
      '«Жинақтаушы құрылымдық бөлім» өрісінде таңдалған қолданушыны «Жинақтаушы/Растау» өрісіне қоса алмайсыз.',
  ...
  ref: {
    ...
    salaryRequested:
      'Сіздің жалақы мөлшері көрсетілген анықтама алу туралы өтінішіңізді адам ресурстары жөніндегі менеджер өңдеуде.',
  ...
  course: {
    ...
    noIssuedCertificates:
      'Кейбір қатысушыларға сертификаттар берілмеді. Курсты аяқтамас бұрын сертификат беруіңізді сұраймыз!',
  ...
  verification: {
    ...
    uploadEdocTitle:
      '*.cms пішіміндегі электрондық құжатты немесе *.zip пішіміндегі мұрағатты таңдауыңыз керек.',
  ...
  responseExplanations: {
    ...
    forbidden:
      'Сұралған ресурсқа кіруге рұқсат етілмейді. Бұл оған кіру үшін қажетті рұқсаттарыңыз болмағандықтан болуы мүмкін.',
    forbiddenAction: 'Әрекетке тыйым салынады. Сізде қажетті рұқсаттар жоқ.',
    internalServerError:
      'Кешіріңіз, біздің тарапымыздан бірдеңе дұрыс болмады. Әрекетті кейінірек қайталаңыз.',
  ...
  mgov: {
    ...
    guidelineLabel:
      'SMART.ENU жүйесінде QR-код арқылы авторизациядан өту немесе құжатқа қол қою үшін',
    ...
    mobileAppNotInstalled:
      'Егер Сізде «eGov Mobile/Business» қосымшасы болмаса, оны төмендегі QR кодтың біреуін сканерлеу арқылы орнатыңыз',
  },
  integration: {
    title: 'Интеграциялар',
  ...
  science: {
    ...
    webOfSciencePublication:
      'Web of Science халықаралық рецензияланатын ғылыми журналдардағы мақала',
  ...
  scienceWorks: {
    ...
    publicationCategories: {
      ...
      afterScientificWorks:
        'Қауымдастырылған профессор (доцент)" ғылыми атағын алғаннан кейін жарияланған ғылыми еңбектері',
      others: 'Өзге',
    ...
    messages: {
      ...
      successPlatonus:
        'Platonus-тан ғылыми еңбектер импорты жүзеге асырылуда. Нәтижелер кейінірек пайда болады!',
      successScopus:
        'Scopus-тан ғылыми еңбектер импорты жүзеге асырылуда. Нәтижелер кейінірек пайда болады!',
    },
    labels: {
  ...
  educationalPrograms: {
    ...
    addCourse: 'Курс қосу',
    coursePrerequisitesCannot:
      'Сіз таңдаған Курстың пререквизиттері бар, сондықтан оны таңдау мүмкін емес',
    ook: 'ЖББК',
  ...
  finance: {
    ...
    kaspiApp: 'Kaspi.kz қосымшасы арқылы',
  },
  enuTopicSettings: {
  ...
  helpDesk: {
    ...
    application: {
      ...
      choseAudience: 'Аудиторияны жазыңыз',
      chooseDiscipline: 'Пәнді таңдаңыз',
      selectSpecialist: 'Маманды жазыңыз',
  ...
  error: {
    ...
    applicationRequirement:
      'Вакансияға өтініш беру үшін жарамды электрондық пошта мекенжайын немесе телефон нөмірін көрсету қажет.',
    400: 'Қате сұрау. Деректерді тексеріңіз.',
    401: 'Авторизация қажет. Жүйеге кіріңіз.',
    403: 'Сізде бұл бетке қол жеткізу құқығы жоқ.',
    404: 'Бет немесе деректер табылмады.',
    500: 'Серверде қате пайда болды. Кейінірек қайталаңыз.',
  ...
  registry: {
    menuTitle: 'Реестрлерді басқару',
    import: 'Импорттау',
    addNewAttribute: 'Жаңа атрибут қосу',
    deleteAttribute: 'Атрибутты жою',
    responsible: 'Жауапты тұлғалар',
    addNewRegistry: 'Жаңа реестр қосу',
    description: 'Сипаттама',
    dataSource: 'Дереккөз',
    numberOfEntries: 'Жазбалар саны',
    accessControl: 'Құқықтарды басқару',
    createDate: 'Жасалу күні',
    ...
    noDataAvailable: 'Қол жетімді деректер жоқ',
    search: 'Іздеу',
    export: 'Экспорт',
    cannotDeleteAttribute: 'Бұл атрибутты жою мүмкін емес',
    managingTableView: 'Кесте көрінісін басқару',
    actionsReferenceBooks: 'Анықтамалықтармен әрекеттер',
    superAdministrator: 'Супер әкімші',
    administrator: 'Әкімші',
    editor: 'Редактор',
    reader: 'Оқырман',
    addNewRole: 'Жаңа рөл қосу',

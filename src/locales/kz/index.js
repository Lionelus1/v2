export default {
    ...
    dissertation: {
        ...
        message: {
            ...
            saveKey: "Дауыс беру анонимді: біз сіздің таңдауыңызды сақтамаймыз. Келешекте өзіңіздің даусыңыздың тексере алуыңыз үшін берілген кілттік сөзді жүктеп немесе сақтап алуығызды сұраймыз. Кілттік сөз тек сізге ғана белгілі және есіңізде сақтап алмаған жағдайда қалпына келтіру мүмкін емес."
        },

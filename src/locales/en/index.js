export default {
    common: {
        ...
        successfullyFormed: 'Report successfully generated',
        deletedSuccessfully: "Deleted Successfully",
        successfullyReset: "Settings successfully reset",
        ...
        message: {
            title: {
                ...
                yearlessthancurrentyear:
                    "The value of the year you select must be less than or equal to the current year",
            ...
            notPermissionForApprove:
                "The selected user does not have the appropriate privileges to reconcile the document",
            fillError: "Not all the data listed. Please fill in all fields!",
            sendToApprovalError:
                "An error occurred while sending for approval. Check the correctness of the specified data!",
            ...
            userSuccessInserted:
                "The user has been successfully created, download the authorization data to send to the user.",
            ...
            ConsulAlwaysHasSameMember:
                "The named person is already a member of another council",
        ...
        downloadAllDocument: "Download all in one archive",
        ...
        projectSupervisor: "Scientific supervisor of the project",
        projectYears: "Implementation Period",
        projectContract: "Contract",
        projectPlan: "Calendar Plan",
        projectPriority: "Priority",
        projectRelevance: "Relevance",
        projectGoal: "Goal",
        projectTypeOfResearch: "Type of research",
        nameOfPriorityArea: "Name of priority area",
        projectObjectives: "Project Objectives",
        projectAppAreas: "Application Areas",
        projectAchievedResults: "Achieved Results",
        projectYear: "Year",
        projectRes: "Result",
        projectPulish: "Publications",
        projectPublishAdd: "Add Publish",
        projectContractNum: "Contract Number",
        projectContractDate: "Contract Date",
        projectClient: "Client",
        projectFundingType: "Funding Type",
    ...
    contragent: {
        ...
        title: "Contragents",
        missingDetails:
            "Details of the selected counterparty are not fully indicated (BIN, etc.). Please provide missing details.",
        menu: {
            select: "Select",
        },
        columns: {
    ...
    doctemplate: {
        ...
        editor: {
            ...
            orgBankAccount: "Bank account",
            signerFullname: "Signer fullname",
            signerFullnameShorten: "Signer fullname(shorten)",
            signerPosition: "Signer position",
            signerCard: "Signer personal information",
            workTypes: "Work types",
            person: "Person",
            sciadvisor: "Project science advisor",
            fullnameShorten: "Fullname(shorten)",
            workTypesItems: "As 1.3 item",
            workTypesTable: "As table",
            agreementDate: "Agreement date",
            mnvoAgreementDate: "Date of agreement with the MES",
            agreementEndDate: "Agreement end date",
            projectPosition: "Position in the project",
            irn: "IRN",
            theme: "Theme",
            mnvoAgreement: "Number of the agreement with the MES",
            agreementSum: "Contract amount ",
            agreementSumText: "Contract amount in words",
            executorWorkPlace: "Main place of work of the Contractor",
            priority: "A priority",
            subpriority: "Subpriority",
        },
        needsApproval:
            "The document created according to the template requires approval",
    ...
    contracts: {
        ...
        columns: {
            ...
            results: "Results",
            task_code: "Code of the task, stage according to the calendar plan",
            work_name: "Names of work under the Contract and the main stages of its implementation",
            start_date: "Start date",
            end_date: "Date of completion",
            result: "Expected Result",
            percentage: "Percentage of the contract amount",
            contractNumber: "Contract number",
            contractDate: "Contract date",
            executorName: "Full name of the Non-staff employee",
            executorWorkPlace: "Position and organization of the main place of work",
            executorPosition: "Position in the project",
            irn: "IRN",
            theme: "Project theme",
            sciadviorName: "Full name of the project manager",
            mnvoNumber: "Number of the agreement with the MES",
            mnvoDate: "Date of agreement with the MES",
            contractSum: "The amount of the contract, thousand tenge",
            serviceDate: "Terms of service provision",
            actSumPercentage: "The amount of the act in %",
            actSum: "The amount of the act, thousand tenge",
            actNumber: "Registration number of the act",
            actDate: "Date of registration of the act",
            actName: "Name of the works/to provide services",
        },
        filter: {
            button: "Fitler",
            author: "Author",
            ...
            priority: "Priority",
            subpriority: "Subpriority",
            mnvo: "Number of the agreement with the MES",
            sciadvisor: "Scientific Project Manager",
        ...
        menu: {
            ...
            registerProtocols: "Register of protocols",
            registerProtocolExtracts: "Related documents",
            protocolsJournalDesc: "List of protocols to be signed and executed",
        },
        ...
        labels: {
            ...
            work_types: "Types of jobs",
            mnvo: "Date of agreement with the MES",
            agreement_end_date: "Service end date",
            project_position: "Position in the project",
            irn: "IRN",
            theme: "Theme",
            mnvo_agreement: "Number of the agreement with the MES",
            agreement_sum: "Contract amount",
            agreement_sum_text: "Contract amount in words",
            executor_work_place: "Main place of work of the Contractor",
            priority: "Priority",
            subpriority: "Subpriority",
            financing_type: "Type of financing",
        },
        ...
        executed: "Executed",
        work_type_note: "Note: For project managers, the maximum number of types of work is 10",
        warnStartBigEnd: "The due date is incorrect",
        persentageNot100: "Incorrect percentages",
        expired: "Expired",
        statusGPC: "Status of GPC acts",
        statusGPCFull: "GPC acts: information on the status and execution of the GPC agreement",
        financingTypes: {
    ...
    hdfs: {
        ...
        saceduprogram: "Education program code and name:",
    },
    ncasigner: {
        chooseFile: "Select  the file",
        qrSinging:
            'You can also sign the document using the mobile application "eGov mobile" by scanning this QR code:',
        noteMark:
            "By continuing to use the Smart.ENU service, you consent to the collection, processing and storage of your personal data to the extent contained in the certificate (electronic digital signature) of the NCA for the purpose of displaying electronic signature data.",
        docIdNotExistMessageForFind:
            "In order to find the signed document page by file, the correct SIGNERAPP identifier must be present in the file name. Make sure that the correct SIGNERAPP ID is specified in your file name.",
        docIdNotExistMessageForSign:
            "In order to sign a previously signed document by file, the correct SIGNERAPP identifier must be present in the file name. Make sure that the correct SIGNERAPP ID is specified in your file name. Otherwise, specify the file name without the SIGNERAPP identifier to create a new signature chain.",
        reload: "Reload the page and try again",
        fileWithIdNotFound:
            "The file with this identifier {dn} was not found in the SIGNERAPP system",
        signedDocPageTitle: "Page of the signed document {name}",
        linkForOthersTitle:
            "Use the link to the page of the signed document in order to give others the opportunity to check signatures and sign this document:",
        copy: "Copy",
        filHasNoIdTitle:
            "The SIGNERAPP ID is missing in the name of the file you selected",
        fileHasNoIdContent:
            "In order to find the signed document page by file, the SIGNERAPP identifier must be present in the file name. Try to find a file of the following format:",
        IncorrectFileTitle:
            "A file with this name {dn} failed signature verification in the SIGNERAPP system",
        ...
        successSignContentFirstRow:
            "Your signature has been verified and has been registered in SIGNAPP",
        successSignContentSecondRow:
            "We recommend saving a copy of the signed file with the <b>SIGNAPP ID</b>. In the future, this will simplify the search for the signed document page in the SIGNAPP service.",
        ...
        tsp: "Put a timestamp",
        tspDescription:
            "Checking the timestamp is carried out for electronic documents of long-term storage. The time stamp is generated at the moment of signing an electronic document when a positive result of the EDS verification is determined, thereby being a proof of signing the document at a specified point in time.",
        signatureListTitle: "List of signatures",
        success: {
            header:
                "Verification of all signatures registered in the system has been successfully completed!",
            subHeader: "This suggests that:",
            firstRow: "all signatures registered in the system are correct;",
            secondRow:
                "the document that was just submitted for verification was signed, no one made any changes to it.",
            //
        ...
        error: {
            api: {
                ...
                fileServerNoResponse:
                    "Error getting file from storage server. Empty response.",
            ...
            signature: {
                cms: {
                    ...
                    emptyData:
                        "There are no initial data for verifying the CMS signature.",
                    multipleSigning:
                        "An error occurred while calculating the hash of the document.",
                },
            },
            tsp: {
                ...
                notVerified:
                    "The timestamp of the electronic signature did not pass the verification.",
            },
            certificate: {
                notFound: "Certificate not found",
                process:
                    "Failed to process the certificate that was obtained from the signing CMS.",
                extract: "Failed to get user certificate from CMS signature.",
                policy: "Unknown certificate policy.",
                mismatchIin:
                    "The IIN received from the certificate is not equal to the user's IIN",
                individual: "The certificate does not belong to an individual",
                ceo: "The certificate does not belong to the first manager",
                financialSignRight:
                    "The certificate does not have the right to sign financial documents",
                signRight: "The certificate does not have the right to be signed",
                hrWorker:
                    "The certificate does not belong to an employee of the HR department",
                employee:
                    "The certificate does not belong to an employee of the organization.",
                expiredOrNotYetValid:
                    "Certificate expired or The validity period of the certificate has not yet arrived",
                notForSigning: "The certificate is not intended for signing",
                notForAuth: "The certificate is not intended for authorization.",
                signRightsNotFound:
                    "The certificate does not have the right to sign documents (required algorithm: GOST)",
                mismatchBin:
                    "The BIN obtained from the certificate is not equal to the BIN specified in the request.",
                requiredBin:
                    "Empty value of the BIN of the organization in the request to sign the document.",
            },
            revocation: {
    ...
    smartenu: {
        ...
        mailings: "Mailings",
        drafts: "Drafts",
        mailingCreateTitle: "Create mailing",
    ...
    dissertation: {
        ...
        validationErrors: {
            ...
            selectDoctorals:
                "Select doctoral students for which the named person is a reviewer",
        },
        vote: {
        ...
        message: {
            ...
            saveKey:
                "Voting is anonymous: we do not store your voting result. Please save or download this password to check your vote in the future. The password is known only to you and is not available for recovery.",
        ...
        setMeetingTimeConfirmMsg:
            "By clicking the {btn} button below, you confirm the correctness of the information and this information is published in the form of an announcement on the site.",
        addMemeberToDisCouncil: "Add Member to The Dissertation Council",
        meetingDateMessage:
            "You can start the Conducting a defence only one day before",
        ...
        generateDiaryReport: 'Diary report',
    ...
    faq: {
        ...
        answerConfirm:
            "The answer will be sent to the sender of the question. Save and send the answer?",
    ...
    hr: {
        ...
        sp: {
            header:
                "The selection process for vacant positions takes place in several stages",
            label1:
                "consideration of resumes of candidates for filling vacant positions of teaching staff, AUP and HR;",
            label2:
                "an interview with an HR specialist and the head of the structural \n " +
                "                unit who applied for recruitment;",
            label3:
                "interview with members of the Competition Commission and summing up the results of the competition.",
            agreement:
                "I have read the rules and certify that the information in my personal resume is correct.\n " +
        ...
        title: {
            ...
            academicTitle: " Academic title",
            academicDetail:
                "Publications, scientific works, inventions, state awards, encouragement (diplomas, etc.)",
            education: "Education",
        ...
        petition: {
            ...
            success:
                "The document has been successfully signed! Send a letter to the candidate.",
            ...
            error:
                "The petition was not signed. Please make sure you have created the document and signed it.",
        },
        report: {
            title: "Report",
    ...
    workPlan: {
        ...
        week: "week",
        monthAndDate: "Month and day",
        textCS: "Contents of the safety topic",
        eventName: "Event name",
        approvalUsers: "Responsible persons",
        safetyPrecautions: "Safety technology",
        conclusionCounterparty: "Conclusion of the counterparty",
        conclusionHeadDepartment: "Evaluation of practice by the Department",
        practiceAssessment: "Assessment of practice",
        quarter: "Quarter",
        ...
        protocol: {
            ...
            meetingTime: "Opening time of the meeting",
            meetingPlace: "Venue of the meeting",
            participatedMembers: "Participated Board Members",
            absentMembers: "Non-participating Board Members",
            addAbsentMembers: "Add Non-participating Board Members",
            reasonAbsence: "Reason for absent",
            quorumInfo: "Information about the presence of a quorum",
            invitedPersons: "Invited persons",
            autogenerate: "Will be generated automatically when creating",
            agendas: "The agenda",
            ...
            con: "Con",
            abstained: "Abstained",
            decisionAccepted: "Decision makers",
            closingTimeMeeting: "Closing time of the meeting",
            addDecision: "Add Decision",
            reported: "Reported",
            boardDecision: "Board Decision",
            responsivePerson:"Responsible person",
            deadline: "Deadline",
            alreadyCreated: "This protocol already created",
            alreadyInsertedUser: "This member already exists",
            viewDecision: "View Decision",
            innerRule: "Inner Rules",
            briefDesc: "Brief description",
            generateDocStatement: "Generate a statement",
            presentDateTime: "Present date",
            listened: "Listened",
            ...
            messages: {
                ...
                decisionRemovedSuccess: "Decision removed successfully",
    ...
    queue: {
        ...
        call: "Call",
        warning:
            "Take a photo of the coupon or print it by clicking on «Print». If you take a photo, be sure to close the window with the «Close button»!!!",
        calledcount: "Сalled",
        serviced: "Serviced",
    ...
    ref: {
        ...
        salaryRequested:
            "Your request for a reference with the amount of salary is being processed by the Human Resources Manager.",
    ...
    course: {
        ...
        isNotAvailable:
            "Аccess is closed to apply for the course, expect a new stream",
        confirmation: "Confirmation",
        warning: "Warning",
    ...
    verification: {
        ...
        uploadEdocTitle:
            "You must select an electronic document in *.cms format or an archive in *.zip format.",
        uploadMainDoc: "Select signed document",
        notDataAttachedTitle:
            "CMS signature does not contain signed data. Please select a source file:",
        successfulVerifying:
            "Verification successful. The CMS signature contains the original data.",
    ...
    responseExplanations: {
        ...
        forbidden:
            "Access to the requested resource is not allowed. This may be because you don't have the necessary permissions to access it.",
        forbiddenAction:
            "Action prohibited. You don't have the required permissions.",
        internalServerError:
    ...
    mgov: {
        ...
        stepTwo:
            "2. Open QR-code scanner in the right-upper corner of the main page",
        stepThree: "3. Point camera on this page to scan the code",
        mobileAppNotInstalled:
            "If you don't have eGov Mobile/Business application installed, scan the QR below",
    },
    integration: {
        title: "Integrations",
    ...
    science: {
        ...
        webOfSciencePublication:
            "Publication in internationally peer-reviewed scientific journals indexed in Web of Science",
        scopusPublication:
            "Publication in internationally peer-reviewed scientific journals indexed in Scopus",
        ...
        recommendedByQACFSHEKazakh:
            "Name of the publication recommended by QACFSHE in Kazakh language",
        recommendedByQACFSHERussian:
            "Edition of the publication recommended by QACFSHE in Russian",
        recommendedByQACFSHEEnglish:
            "Edition of the publication recommended by QACFSHE in English",
        requester: "Requester",
        ...
        customerAndSourceInRussia:
            "Customer and source of funding in Russian language",
        customerAndSourceInKazakh:
            "Customer and source of funding in Kazakh language",
        customerAndSourceInEnglish:
            "Customer and source of funding in English language",
    ...
    scienceWorks: {
        ...
        menu: {
            ...
            newPublicationsKoksnvo:
                "Request to add new publication recommended by QACFSHE",
        ...
        messages: {
            ...
            successPlatonus:
                "Scientific works from Platonus are imported. Results will come later!",
            successScopus:
                "Scientific works from Scopus are imported. Results will come later!",
        },
        labels: {
            ...
            editionFullName:
                "Edition (title, year, page number) / No. of copyright certificate, patent",
    ...
    helpDesk: {
        instructionNumber: "Language of instruction",
        nameOftheTrainingProgram: "Name of the training program",
        ...
        application: {
            ...
            choseAudience: "Write to a audience",
            chooseDiscipline: "Choose a discipline",
            selectSpecialist: "Write to a specialist",
    ...
    registry: {
        ...
        search: 'Search',
        export: 'Export',
        cannotDeleteAttribute: 'You cannot delete this attribute',
        managingTableView: 'Managing Table View',
        actionsReferenceBooks: 'Actions with Reference Books',

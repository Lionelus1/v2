export default {
    ...
    contracts: {
        ...
        contragentWarning:
            "No counterparty consent has been requested for this contract or you do not have permission to view this document!",
    ...
    workPlan: {
        ...
        conclusionHeadDepartment: "Conclusion of the head of the department",
        practiceAssessment: "Practice assessment",
        quarter: "Quarter",
    ...
    course: {
        ...
        certificate: {
            ...
            confirm2:
                "The certificate will be issued With the application, do you confirm the correctness of filling out the application?",

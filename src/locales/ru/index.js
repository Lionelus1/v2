export default {
    ...
    science: {
        ...
        recommendedByQACFSHERussian:'Издание издания, рекомендуемое КОКСНВО на русском языке',
        recommendedByQACFSHEEnglish:'Издание издания, рекомендуемое КОКСНВО на английском языке',

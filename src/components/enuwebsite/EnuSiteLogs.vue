...
export default {
    ...
    methods: {
        ...
        convertYearToInt() {
            this.lazyParams.filter.year = parseInt(this.lazyParams.filter.year);
            this.getTableLogs();
        },
        convertMonthToInt() {
            this.lazyParams.filter.month = parseInt(this.lazyParams.filter.month);
            this.getTableLogs();
        },
        convertDayToInt() {
            this.lazyParams.filter.day = parseInt(this.lazyParams.filter.day);
            this.getTableLogs();
        },
        convertHourToInt() {
            this.lazyParams.filter.hour = parseInt(this.lazyParams.filter.hour);
            this.getTableLogs();
        },
        convertMinuteToInt() {
            this.lazyParams.filter.minute = parseInt(this.lazyParams.filter.minute);
            this.getTableLogs();
        }
    },
}

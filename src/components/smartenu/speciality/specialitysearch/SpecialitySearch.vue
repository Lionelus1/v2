  ...
  <div :class="containerClass" :style="style">
    ...
    <ul :class="['p-inputtext p-chips-multiple-container', {'p-disabled': $attrs.disabled, 'p-focus': focused}]" @click="onWrapperClick()">
      ...
      <li class="p-chips-input-token">
        <input :placeholder="(foundSpecialists == null ? $t('common.enter'): null)" aria:haspopup="true" ref="input" type="text" v-bind="$attrs" @focus="onFocus"
               @blur="onBlur($event)" @input="onInput" @keydown="onKeyDown($event)" @keyup="onKeyUp($event)" @paste="onPaste($event)"

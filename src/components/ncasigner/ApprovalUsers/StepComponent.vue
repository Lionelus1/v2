  ...
  <div class="container" id="app" v-cloak>
    <div class="steps" v-if="mode == 'standard'">
      ...
      <div class="steps-content p-fluid">
        <FindUser @add="updateModel" @remove="updateModel" v-model="selectedUsers" searchMode="local" :user-type="3"  :disabled="readonly"></FindUser>
    ...
    <div class="steps" v-else>
      ...
      <div class="steps-content p-fluid">
        ...
        <FindUser :disabled="readonly || !approvalStages[activeIndex].userChangeable" class="mt-2" @add="updateModel" @remove="updateModel" v-model="selectedUsers" searchMode="local" :user-type="3"></FindUser>

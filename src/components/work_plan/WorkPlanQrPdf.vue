<template>
  <div>
    <div ref="qrToPdf" class="p-grid">
      ...
      <br/>
      <div class="p-col-12" v-if="signatures" >
        <div id="qr" v-for="(item, index) of signatures" :key="index" style="border: 1px solid #000; padding: 5px; margin: 5px;display: inline-block;">
          ...
          <div style="width: 100%;text-align: center;">
            <qrcode-vue size="300" render-as="svg"  :value="item.signature" level="L"></qrcode-vue>
          </div>
        </div>
      </div>
    </div>

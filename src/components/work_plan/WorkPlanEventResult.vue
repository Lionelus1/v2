...
export default {
  ...
  methods: {
    ...
    saveResult() {
      ...
      if (!this.isDirectorsPlan && !this.isStandartPlan && !this.isMastersPlan && !this.isDoctorsPlan && (this.inputWordCount > this.wordMaxLimit || this.inputWordCount < this.wordLimit)) {

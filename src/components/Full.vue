    ...
    return {
      ...
      menu: [
        ...
        // {label: 'View Source', icon: 'pi pi-fw pi-search', command: () => {window.location = "https://github.com/primefaces/sigma-vue"}},
        {
          ...
          items: [
            {
              label: "Келісім-шарт үлгілері",
              icon: "pi pi-fw pi-book",
              to: "/documents/doctemplate",
            },
            {
              label: "Келісім-шарттар",
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              to:
                "/contragent/persons/" + Enum.PersonType.IndividualEntrepreneur,
            },
            {
              label: "Қызметкерлер",
              icon: "pi pi-fw pi-user",
        ...
        {
          label: this.$t("smartenu.newsTitle"),
          icon: "pi pi-fw pi-users",
          items: [
            {
            ...
            {
              label: this.$t("smartenu.newsList"),
              icon: "pi pi-fw pi-money-bill",
              to: "/smartenu/admin/news/newstable",
            },
          ],
        },
        {
          label: this.$t("smartenu.eventsTitle"),
          icon: "pi pi-fw pi-folder",
          to: "/smartenu/admin/events/events",
        },
        {
            label: "Сұрақ-жауап",
            icon: "pi pi-fw pi-folder",

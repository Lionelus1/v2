    ...
    <h3>{{ $t("dissertation.doctorals") }}</h3>
      ...
      >
        <div class="grid formgrid">
          ...
          <div class="col-12 pb-2 lg:col-6 mb-lg-0">
            ...
            <DepartmentList class="pt-1" ref="cafedraList" :orgType="3" v-model="doctoral.cafedra" :editMode="true"></DepartmentList>
            <small
                class="p-error"
          ...
          <div class="col-12 pb-2 lg:col-6 mb-lg-0">
            ...
            <SpecialitySearch :style="'height:38px'" class="pt-1" :max="1" :educationLevel="Enums.EducationLevel.Doctorate"
                              v-model="selectedSpecialities" id="speciality"></SpecialitySearch>
            <small class="p-error"
                   v-if="(submitted && validationErrors.speciality)">{{ $t('dissertation.validationErrors.selectSpeciality') }}</small>
          </div>
          <div class="col-12 pb-2 lg:col-6 mb-lg-0">
          ...
          <div class="col-12 pb-2 lg:col-6 mb-lg-0">
            ...
            <PrimeCalendar :placeholder="$t('common.select')" style="height:33px" class="pt-1" id="graduationyear" v-model="doctoral.graduationYear"
          ...
          <div class="col-12 pb-2 lg:col-6 mb-lg-0">
            ...
            <PrimeCalendar :placeholder="$t('common.select')" style="height:33px" class="pt-1" id="admissionyear" v-model="doctoral.admissionYear"
                           view="year" dateFormat="yy"/>
          ...
          <div class="col-12 pb-2 lg:col-12 mb-lg-0">
            ...
            <InputText :placeholder="$t('common.enter')" class="pt-1" type="text" id="namekz" v-model="doctoral.dissertation.namekz"/>
          ...
          <div class="col-12 pb-2 lg:col-12 mb-lg-0">
            ...
            <InputText :placeholder="$t('common.enter')" class="pt-1" type="text" id="nameru" v-model="doctoral.dissertation.nameru"/>
          ...
          <div class="col-12 pb-2 lg:col-12 md:col-6 mb-lg-0">
            ...
            <InputText :placeholder="$t('common.enter')" class="pt-1" type="text" id="nameen" v-model="doctoral.dissertation.nameen"/>
          ...
          <div class="col-12 pb-2 lg:col-12 mb-lg-0">
            ...
            <Textarea :placeholder="$t('common.enter')" class="pt-1" type="text" id="annotationkz" v-model="doctoral.dissertation.annotation.kz"/>
          ...
          <div class="col-12 pb-2 lg:col-12 mb-lg-0">
            ...
            <Textarea :placeholder="$t('common.enter')" class="pt-1" type="text" id="annotaionru" v-model="doctoral.dissertation.annotation.ru"/>
      ...
      >
        <div>
          ...
          <InputText id="doctoralName" class="pt-2 mb-2" type="text" readonly="true" v-model="selectedDoctoral.user.fullName"/>
        </div>
        <div>
          <label for="defenseLanguage">{{ $t("dissertation.defenseLang") }}</label>
          <SelectButton id="defenseLanguage" style="height:35px" v-model="selectedDoctoral.dissertation.language" :options="language"
                        class="mt-1 mb-2">
            <template #option="slotProps">
              <div v-if="slotProps.option == 1">{{ $t('common.language.kz') }}</div>
              <div v-else-if="slotProps.option == 2">{{ $t('common.language.ru') }}</div>
        ...
        <div>
          ...
          <PrimeCalendar id="meetingTime" :placeholder="$t('common.select')" style="height:33px" class="pt-1" v-model="selectedDoctoral.meetingTime"
                         :showTime="true" :showIcon="true" :stepMinute="10" :manualInput="true" dateFormat="dd.mm.yy"/>
        ...
        <template #footer>
          ...
          <Button
              ...
              icon="pi pi-check"
              class="p-button-text"
              @click="confirmSetMeetingTime"
          />
        </template>
      </Dialog>
      <Dialog
          v-model:visible="dialog.setMeetingTimeConfirm.state"
      ...
      >
        ...
        <DataTable v-if="regInfoDetail && isSecretary && selectedDoctoral.dissertation.state == dissertationState.ReadyToRegister" :loading="loading"
                   :value="regInfoDetail" showGridlines responsiveLayout="scroll">
        ...
        <div v-if="voteInfo">
          ...
          <p>
            ...
            {{ (selectedDoctoral.dissertation.state === dissertationState.VotingRestarted ? voteInfo.voted2 : voteInfo.voted) }}
          </p>
          <ProgressBar
              ...
              <div v-if="isDissertationAdmin" :style="printStyle">
                ...
                <p style="text-align:left">
                  ...
                  <b>{{ $t('dissertation.directionCode') }}:&nbsp;</b>{{
                    selectedDoctoral.speciality.trainingDirection.code + '-' + selectedDoctoral.speciality.trainingDirection.nameInKz
                  }}<br/>
        ...
        >
          ...
          <div id="keyword">
            <p ref="content" style="border: 1px solid blue;margin-top:5px;padding: 5px;">{{ $t("common.voteKeyword") }}:&nbsp;<span
                style="text-decoration: underline;font-weight: bold;">{{ password }}</span>
...
export default {
  ...
  methods: {
    ...
    initMembers(roleName) {
      ...
      console.log("members", this.memberList.filter(x => x.roles.some(q => q.name === roleName)).map(w => w.fullName))

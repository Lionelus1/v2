<template>
  <div class="card">
    <div class="p-field" v-if="section === chapter.education">
    ...
    <div class="p-field" v-if="section === chapter.language">
    ...
    <div class="p-field" v-if="section === chapter.experience">
    ...
    <div class="p-field" v-if="section === chapter.refresherCourse">
    ...
    <div class="p-field" v-if="section === chapter.referee">
    ...
    <div class="p-field" v-if="section === chapter.id">
    ...
    <div class="p-field" v-if="section === chapter.academicDetail">
    ...
    <div class="p-field" v-if="section === chapter.info">

  ...
  <div class="p-editor-container">
    <div ref="toolbarElement" class="p-editor-toolbar">
      <slot name="toolbar">
        ...
        <span class="ql-formats">
          <button class="ql-table" value="table" type="button"></button>
    ...
    <div class="p-fluid">
      ...
      <template #footer>
          <Button label="Жоқ" icon="pi pi-times" @click="closeModal" class="p-button-text"/>
          <Button label="Йә" icon="pi pi-check" @click="insertModal" autofocus />
      </template>
    </Dialog>
  </div>
...
export default {
  ...
  mounted() {
    ...
    const dropDownItems = {
      "ourside" : this.$t('doctemplate.editor.ourside'),
      "contragent" : this.$t('doctemplate.editor.contragent'),
      "place": this.$t('doctemplate.editor.place'),
    ...
    const myDropDown = new QuillToolbarDropDown({
      label: this.$t('doctemplate.editor.contractElements'),
  ...
  methods: {
    ...
    openModal(value) {
      ...
      if (value == "text") {
        ...
        this.agreementElement =" {" + this.agreementElement + "} ";
        this.agreementDesctiption = "";
        const { index, length } = this.quill.selection.savedRange;
        this.quill.deleteText(index, length);
        this.quill.insertText(index, this.agreementElement, {
          'color': 'blue',
          'italic': true,
          'bold': true,
        });
        this.quill.insertText(index + this.agreementElement.length, " ", {
          'color': 'black',
          'italic': false,
          'bold': false,
        });
        ...
        this.quill.in
        this.quill.setSelection(index + this.agreementElement.length+1);
    ...
    insertModal() {
      if(this.agreementDesctiption=="")
        return
      this.agreementElement =" {" + this.agreementElement +  ":" + this.agreementDesctiption + "} ";
      this.agreementDesctiption = "";
      const { index, length } = this.quill.selection.savedRange;
      this.quill.deleteText(index, length);
      this.quill.insertText(index, this.agreementElement, {

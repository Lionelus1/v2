<template>
  ...
  <Dialog :header="$t('doctemplate.newTemplate') " v-model:visible="newTemplateDialogVisible" :modal="true"
    ...
    <template #footer>
      <div class="p-fluid">
        <Button :label="$t('common.save')" :disabled="!(template.name && template.name.trim() != '')" @click="saveCertificateTemplate"
...
export default {
        ...
        params: [
          {
            ...
            description: "common",
            isDeleted: false,
            value: {url: "enu_logo/bg-orange.jpg", title: "background", rectelement: {z: 0, x: 0, y: 0, w: 840, h: 593}}
          },
          {
            id: -1,
            name: "txt",
            ...
            value: {
              name: "organizer",
              title: "@сourseOrganizer",
              titlekz: "@курстыҰйымдастырушы",
              titleru: "@организаторКурса",
              rectelement: {z: 1, x: 0, y: 80, w: 840, h: 30},
              style: "font-weight:bold;text-align:center;font-size:14px;color:#007dbe;letter-spacing:0px"
            }
          },
          {
            id: -1,
            ...
            value: {
              ...
              titlekz: "СЕРТИФИКАТ",
              titleru: "CЕРТИФИКАТ",
              rectelement: {z: 2, x: 306, y: 120, w: 230, h: 50},
              style: "text-align:center;font-size:32px;color:#007dbe;letter-spacing:2px"
            }
          },
          {
            id: -1,
            ...
            active: false,
            isDeleted: false,
            value: {url: "enu_logo/qr.png", name: "qr", rectelement: {z: 3, x: 643, y: 380, w: 70, h: 70}}
          },
          {
            id: -1,
            name: "img",
            ...
            active: false,
            isDeleted: false,
            value: {url: "enu_logo/build.png", name: "build", rectelement: {z: 4, x: 585, y: 470, w: 170, h: 70}}
          },
          {
            id: -1, name: "txt", description: "common", active: false, isDeleted: false, value: {
              name: "mainText", title: "mainInfo",
          ...
          {
            id: -1, name: "txt", description: "common", value: {
              name: "number", title: "details",
          ...
          },
          {
            ...
            active: false,
            isDeleted: false,
            value: {url: "enu_logo/logo-kz.png", title: "logo", rectelement: {z: 7, x: 340, y: 15, w: 163, h: 60}}
          },
          {
            id: -1,
            name: "img",
            ...
            active: false,
            isDeleted: false,
            value: {url: "enu_logo/logo-en.png", title: "logo", rectelement: {z: 8, x: 349, y: 15, w: 144, h: 60}}
          },
          {
            id: -1,
            name: "img",
            ...
            active: false,
            isDeleted: false,
            value: {url: "enu_logo/logo-en.png", title: "logo", rectelement: {z: 9, x: 349, y: 15, w: 144, h: 60}}
          },
  ...
  computed: {
    justifyOptions() {
      return [
        {
          icon: 'pi pi-align-left', value: 'Left', command: () => {
            this.activeElement.textAlign = "left";
            this.calcStyle()
          }
        },
        {
          icon: 'pi pi-align-right', value: 'Right', command: () => {
            this.activeElement.textAlign = "right";
            this.calcStyle()
          }
        },
        {
          icon: 'pi pi-align-center', value: 'Center', command: () => {
            this.activeElement.textAlign = "center";
            this.calcStyle()
          }
        },
        {
          icon: 'pi pi-align-justify', value: 'Justify', command: () => {
            this.activeElement.textAlign = "justify";
            this.calcStyle()
          }
        }
      ]

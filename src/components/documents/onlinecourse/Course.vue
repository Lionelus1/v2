  ...
  <div v-if="course">
    ...
    <div class="course_card block sm:flex p-4">
      ...
      <div class="text text-white">
        <div class="flex mb-4">
          <h5 v-if="course.history[0].stateID === 8" class="mb-0 mr-2">{{ course["name" + $i18n.locale] }} - <span class="text-gray-400">{{
              this.$t("course.isNotAvailable")
            }}</span>
          </h5>
            ...
            <template #header>
              <div class="table-header flex justify-content-between flex-wrap card-container purple-container">
                <div class="flex gap-2 flex-column sm:flex-row">
                  ...
                  <ActionButton v-if="findRole(null,'online_course_administrator') && dic_course_type === 1" :show-label="true" :items="menu"
                                @toggle="toggleAction(data)"></ActionButton>
              ...
              <template #body="slotProps">
                <div class="buttons-container">
                  ...
                  <div class="delete-button">
                    <Button v-if="findRole(null,'online_course_administrator')" @click="deleteStudent(slotProps.data)" class="p-button-text p-button-danger p-1 trash-button"
      ...
      <div class="card">
        <div class="grid formgrid">
          ...
          <div class="col-12 mb-2 pb-2 lg:col-6 mb-lg-0">
            ...
            <Dropdown :disabled="!checkedCertificate" v-model="course.certificate_template_id" :options="certificates" class="mt-2" :optionLabel="itemLabel" optionValue="id"

  ...
  <div class="ontent-section">
            ...
            >
              ...
              >
                ...
                <label
                  ...
                  :for="param.name + param.id"
                  class="col-12 p-mb-2 md:col-2 p-mb-md-0"
                  >{{ $t("doctemplate.editor." + param.name) }}</label
                >
                <label
                  v-else
    ...
    >
      <div class="grid p-formgrid">
        <div class="col-12 p-mb-2 lg:col-3 p-mb-lg-1">
          <label for="catalog">{{ $t("contracts.journal") }}</label>
        </div>
        <div class="col-12 p-mb-2 lg:col-9 p-mb-lg-1 p-pr-2">
          <InputText
            readonly="true"
            :modelValue="
              this.$i18n.locale === 'kz'
        ...
        <div class="col-12 p-mb-2 lg:col-3 p-mb-lg-0">
          <label for="regnum">{{ $t("contracts.regnum") }}</label>
        </div>
        <div class="col-6 p-mb-2 lg:col-4 p-mb-lg-2 p-pr-2">
          <InputText
        ...
        <div class="col-3 p-mb-2 lg:col-5 p-mb-lg-0">
